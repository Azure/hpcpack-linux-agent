...
public interface ISystemService
{
    ...
    Dictionary<string, ulong> GetNetworkUsageInBytes();

    Task<Dictionary<string, ulong>> GetIbNetworkUsageAsync(CancellationToken cancellationToken = default);

    Task<List<string>> GetIbDevicesAsync(CancellationToken cancellationToken = default);

    Task<List<ExtendedGpuInfo>> GetGpuInfoAsync(CancellationToken cancellationToken = default);
...
";
    ...
    [SupportedOSPlatform("linux")]
    public Dictionary<string, ulong> GetNetworkUsageInBytes()
    {
        throw new NotImplementedException();
    }

    [SupportedOSPlatform("linux")]
    public Task<Dictionary<string, ulong>> GetIbNetworkUsageAsync(CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }

    [SupportedOSPlatform("linux")]
    public Task<List<string>> GetIbDevicesAsync(CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }

    [SupportedOSPlatform("linux")]
    public async Task<List<ExtendedGpuInfo>> GetGpuInfoAsync(CancellationToken cancellationToken = default)
    {
    ...
    public List<ExtendedGpuInfo> ParseGpuInfoContent(string[] lines)
    {
