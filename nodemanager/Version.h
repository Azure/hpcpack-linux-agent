                    ...
                    { "2.4.0.0",
                        {
                            ...
                            "Add build-in execution filter to adjust task affinity in terms of core distribution in NUMA nodes",
                            "Add build-in execution filter to modify command for preparation of mpi task",
                            ...
                            "Add build-in execution filter to modify command for supporting downloading input files and uploading output files of task with HpcData service",
